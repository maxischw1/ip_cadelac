...
#     joint_vel_limits = 2.5 * np.ones(nq)
#     # upper_joint_pos_limits = 2.5 * np.ones(nq)
#     # lower_joint_pos_limits = -2.5 * np.ones(nq)
...
#     fourier_config = {"order": 5, "duration": 10}
#     robot_config = {"njoints": nq, 
#                     "init_pos": init_pos,
#                     "init_vel": init_vel,
...
#     t, qs, qds, qdds, init_params = obtain_valid_traj_param_simplified(
...
#         axes[cor].plot(t, qs[:,cor])
#         axes[cor].plot(t[0], init_pos[cor], '*k')
#         axes[cor].plot(t[-1], init_pos[cor], '*k')
#         axes[cor].grid()
#     # Show the plot
...
#     fig, axes = plt.subplots(ncor, 1, figsize=(14, 8))
#     for cor in range(ncor):
#         axes[cor].plot(t, qds[:,cor])
#         axes[cor].plot(t[0], init_vel[cor], '*k')
#         axes[cor].plot(t[-1], init_vel[cor], '*k')
#         axes[cor].grid()
#     # Show the plot
